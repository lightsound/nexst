...
export const ToolbarButtonsBasicMarks = () => {
  ...
  return (
    <>
      ...
      <ToolbarMark type={getPlatePluginType(editor, MARK_STRIKETHROUGH)} icon={<FormatStrikethrough />} />
      <ToolbarMark type={getPlatePluginType(editor, MARK_CODE)} icon={<CodeAlt />} />
    </>
  );
};
...
export const BallonToolbarMarks = () => {
  ...
  return (
    <BalloonToolbar direction={direction} hiddenDelay={hiddenDelay} theme={theme} arrow={isArrow}>
      <ToolbarMark
